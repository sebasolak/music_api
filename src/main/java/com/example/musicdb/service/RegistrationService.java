...
import com.example.musicdb.model.appuser.AppUserRole;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        String link = urlProvider.getTokenConfirmationUrl() + token;
        emailService.sendConfirmationToken(
                request.getEmail(),
    ...
    public String confirmToken(String token) {
        ...
        appUserService.enableAppUser(confirmationToken.getAppUser().getLogin());
        return "confirmed";
    }
